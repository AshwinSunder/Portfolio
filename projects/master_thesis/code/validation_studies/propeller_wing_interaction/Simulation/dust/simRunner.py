...
def run_dust(dust_pre_file="dust_pre.in",dust_file="dust.in",dust_post_files=["dust_post.in"],input_file_loc="."):

    if os.path.isfile(os.path.join(input_file_loc,dust_pre_file)):
        os.system("dust_pre "  + os.path.join(input_file_loc,dust_pre_file))

    if os.path.isfile(os.path.join(input_file_loc,dust_file)):
        os.system("dust "      + os.path.join(input_file_loc,dust_file))

    for i in range(len(dust_post_files)):
        if os.path.isfile(os.path.join(input_file_loc,dust_post_files[i])):
            os.system("dust_post "+ os.path.join(input_file_loc,dust_post_files[i]))
